...
- **`feat/code-review` → PR #2**, all checks green: `verify`, `eslint-review`,
  Vercel.
...
1. **Branch protection.** Add a ruleset on `main` requiring the **`verify`** and
   **`eslint-review`** checks. CI failed on PR #1 and merged anyway because
